...
This experiment was created using PsychoPy3 Experiment Builder (v2020.2.10),
    on Tue 06 Jul 2021 09:49:34 PM IST
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/home/khyathi/Desktop/surge/Foraging task/foraging basic env 2/untitled_lastrun.py',
...
tree1_2.setPos((-0.5, -0.2))
tree2_2.setPos((0.5, 0.2))
tree3_2.setPos((-0.5, 0.6))
tree4_2.setPos((0.5, -0.6))
# keep track of which components have finished
startframeComponents = [mouse, square_2, tree1_2, tree2_2, tree3_2, tree4_2]
...
for thisReward1 in reward1:
    ...
    gotValidClick = False  # until a click is received
    # keep track of which components have finished
    rewardframe1Components = [tree1_4, tree2_4, tree3_4, tree4_4, square_4, reward_2, resp, forward, squaree, skip]
...
for thisPos1 in pos1:
    ...
    tree3_6.setPos((-0.5, tree3_n))
    tree4_6.setPos((0.5, tree4_p))
    # keep track of which components have finished
    movetreesComponents = [tree1_6, tree2_6, tree3_6, tree4_6, square_6]
...
for thisTrial in trials:
    ...
    for thisReward2 in reward2:
        ...
        gotValidClick = False  # until a click is received
        # keep track of which components have finished
        rewardframe2Components = [tree1_5, tree2_5, tree3_5, tree4_5, square_5, reward_3, resp_3]
    ...
    for thisReward3 in reward3:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        tree1_7.setPos((-0.5, 0.6))
        tree2_7.setPos((0.5, 0.2))
        tree3_7.setPos((-0.5, -0.2))
        ...
        gotValidClick = False  # until a click is received
        # keep track of which components have finished
        rewardframe3Components = [tree1_7, tree2_7, tree3_7, tree4_7, square_7, reward_4, resp_4]
    ...
    for thisPos3 in pos3:
        ...
        tree3_9.setPos((-0.5, tree3_n))
        tree4_9.setPos((0.5, tree4_p))
        # keep track of which components have finished
        ...
        while continueRoutine and routineTimer.getTime() > 0:
            ...
            if tree1_9.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > tree1_9.tStartRefresh + 0.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if tree2_9.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > tree2_9.tStartRefresh + 0.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if tree3_9.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > tree3_9.tStartRefresh + 0.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if tree4_9.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > tree4_9.tStartRefresh + 0.5-frameTolerance:
                    # keep track of stop time/frame for later
            ...
            if square_9.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > square_9.tStartRefresh + 0.5-frameTolerance:
                    # keep track of stop time/frame for later
        ...
        for thisComponent in movetrees_3Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        pos3.addData('tree1_9.started', tree1_9.tStartRefresh)
        pos3.addData('tree1_9.stopped', tree1_9.tStopRefresh)
        pos3.addData('tree2_9.started', tree2_9.tStartRefresh)
        pos3.addData('tree2_9.stopped', tree2_9.tStopRefresh)
        pos3.addData('tree3_9.started', tree3_9.tStartRefresh)
        pos3.addData('tree3_9.stopped', tree3_9.tStopRefresh)
        pos3.addData('tree4_9.started', tree4_9.tStartRefresh)
        pos3.addData('tree4_9.stopped', tree4_9.tStopRefresh)
        pos3.addData('square_9.started', square_9.tStartRefresh)
        pos3.addData('square_9.stopped', square_9.tStopRefresh)
        thisExp.nextEntry()
    ...
    for thisReward4 in reward4:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        tree1_10.setPos((-0.5, -0.6))
        tree2_10.setPos((0.5, -0.2))
        tree3_10.setPos((-0.5, 0.2))
        tree4_10.setPos((0.5, 0.6))
        reward_5.setText(rewardval4)
        # setup some python lists for storing info about the resp_5
        resp_5.clicked_name = []
        gotValidClick = False  # until a click is received
        # keep track of which components have finished
        rewardframe4Components = [tree1_10, tree2_10, tree3_10, tree4_10, square_10, reward_5, resp_5]
        ...
        for thisComponent in rewardframe4Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        reward4.addData('tree1_10.started', tree1_10.tStartRefresh)
        reward4.addData('tree1_10.stopped', tree1_10.tStopRefresh)
        reward4.addData('tree2_10.started', tree2_10.tStartRefresh)
        reward4.addData('tree2_10.stopped', tree2_10.tStopRefresh)
        reward4.addData('tree3_10.started', tree3_10.tStartRefresh)
        reward4.addData('tree3_10.stopped', tree3_10.tStopRefresh)
        reward4.addData('tree4_10.started', tree4_10.tStartRefresh)
        reward4.addData('tree4_10.stopped', tree4_10.tStopRefresh)
        reward4.addData('square_10.started', square_10.tStartRefresh)
        reward4.addData('square_10.stopped', square_10.tStopRefresh)
    ...
    # set up handler to look after randomisation of conditions etc
    pos4 = data.TrialHandler(nReps=1, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('pos.xlsx'),
        seed=None, name='pos4')
    ...
    for thisPos4 in pos4:
        ...
        for thisComponent in movetrees_2Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        pos4.addData('tree1_8.started', tree1_8.tStartRefresh)
        pos4.addData('tree1_8.stopped', tree1_8.tStopRefresh)
        pos4.addData('tree2_8.started', tree2_8.tStartRefresh)
        pos4.addData('tree2_8.stopped', tree2_8.tStopRefresh)
        pos4.addData('tree3_8.started', tree3_8.tStartRefresh)
        pos4.addData('tree3_8.stopped', tree3_8.tStopRefresh)
        pos4.addData('tree4_8.started', tree4_8.tStartRefresh)
        pos4.addData('tree4_8.stopped', tree4_8.tStopRefresh)
        pos4.addData('square_8.started', square_8.tStartRefresh)
        pos4.addData('square_8.stopped', square_8.tStopRefresh)
        thisExp.nextEntry()
        
    # completed 1 repeats of 'pos4'
    ...
    for thisReward5 in reward5:
        ...
        continueRoutine = True
        # update component parameters for each repeat
        tree1_11.setPos((-0.5, 0.6))
        tree2_11.setPos((0.5, 0.2))
        tree3_11.setPos((-0.5, -0.2))
        tree4_11.setPos((0.5, -0.6))
        ...
        gotValidClick = False  # until a click is received
        # keep track of which components have finished
        rewardframe5Components = [tree1_11, tree2_11, tree3_11, tree4_11, square_11, reward_6, resp_6]
        ...
        for thisComponent in rewardframe5Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        reward5.addData('tree1_11.started', tree1_11.tStartRefresh)
        reward5.addData('tree1_11.stopped', tree1_11.tStopRefresh)
        reward5.addData('tree2_11.started', tree2_11.tStartRefresh)
        reward5.addData('tree2_11.stopped', tree2_11.tStopRefresh)
        reward5.addData('tree3_11.started', tree3_11.tStartRefresh)
        reward5.addData('tree3_11.stopped', tree3_11.tStopRefresh)
        reward5.addData('tree4_11.started', tree4_11.tStartRefresh)
        reward5.addData('tree4_11.stopped', tree4_11.tStopRefresh)
        reward5.addData('square_11.started', square_11.tStartRefresh)
        reward5.addData('square_11.stopped', square_11.tStopRefresh)
    ...
    # set up handler to look after randomisation of conditions etc
    pos5 = data.TrialHandler(nReps=1, method='sequential', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('pos.xlsx'),
        seed=None, name='pos5')
    ...
    for thisPos5 in pos5:
        ...
        for thisComponent in movetrees_3Components:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        pos5.addData('tree1_9.started', tree1_9.tStartRefresh)
        pos5.addData('tree1_9.stopped', tree1_9.tStopRefresh)
        pos5.addData('tree2_9.started', tree2_9.tStartRefresh)
        pos5.addData('tree2_9.stopped', tree2_9.tStopRefresh)
        pos5.addData('tree3_9.started', tree3_9.tStartRefresh)
        pos5.addData('tree3_9.stopped', tree3_9.tStopRefresh)
        pos5.addData('tree4_9.started', tree4_9.tStartRefresh)
        pos5.addData('tree4_9.stopped', tree4_9.tStopRefresh)
        pos5.addData('square_9.started', square_9.tStartRefresh)
        pos5.addData('square_9.stopped', square_9.tStopRefresh)
        thisExp.nextEntry()
        
    # completed 1 repeats of 'pos5'
